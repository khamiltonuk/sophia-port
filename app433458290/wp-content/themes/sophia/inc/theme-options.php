...
function runo_theme_options_render_page() {
	...
	<div class="wrap">
		...
		<?php echo __( '<h3>Missing some options?</h3><p>Only in Premium version: select your own background image or color; font options. Some examples:</p>', 'runo' ) ?>
		<p><img alt="Premium theme" src="<?php echo get_template_directory_uri(); ?>/inc/images/premium-screenshots.png" /></p>
		<p><strong><a href="http://runo.lala.fi/buy"> &raquo; <?php echo __( 'Take a look', 'runo' ) ?></a></strong></p>
	</div>
	<?php
}
